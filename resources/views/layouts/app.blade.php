...
<head>
    ...
    <!-- Styles -->
    <!-- <link rel="stylesheet" type="text/css" href="/assets/css/black-dashboard.min.css"> -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/home">Pinjam</a>
                        </li>
                       @hasrole('admin')
                            <li class="nav-item">
                       ...
                       @impersionate()
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.impersionate.destroy') }}">Berhenti</a>
                            </li>
                       @endimpersionate
                    </ul>
