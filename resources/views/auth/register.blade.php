...
<div class="container">
    <div class="row justify-content-center pt-5">
        <div class="col-md-6 pt-5">
            <div class="card shadow pb-5" style="border-radius: 15px;">
                <div class="card-body">
                    <p class="lead text-center font-weight-bold">Daftar</p>
                    <hr>
                    <form method="POST" action="{{ route('register') }}" class="my-5">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary col-4 rounded-pill">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
